...
const Api = {
  ...
  deleteInvoice(invoiceNo)    { return this._post({ action: 'deleteInvoice', invoiceNo }); },
  markInvoicePaid(invoiceNo, amountPaid, datePaid, paymentNote) {
    return this._post({ action: 'markInvoicePaid', invoiceNo, amountPaid, datePaid, paymentNote });
  },
  clearInvoicePayment(invoiceNo) { return this._post({ action: 'clearInvoicePayment', invoiceNo }); },
